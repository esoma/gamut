// generated 2022-03-07 23:13:00.206594 from codegen/math/templates/_vector.hpp
...
static PyObject *
U16Vector3__add__(U16Vector3 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((U16Vector3 *)other)->glm);
    }
...
static PyObject *
U16Vector3__sub__(U16Vector3 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U16Vector3Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
U16Vector3__mul__(U16Vector3 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U16Vector3Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    U16Vector3__truediv__(U16Vector3 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        U16Vector3Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((U16Vector3 *)other)->glm)[0] == 0 ||

                        (*((U16Vector3 *)other)->glm)[1] == 0 ||

                        (*((U16Vector3 *)other)->glm)[2] == 0
...
U16Vector3_getbufferproc(U16Vector3 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "U16Vector3 is not read only");
        view->obj = 0;
        return -1;
    }
...
static PyObject *
U16Vector3_get_limits(U16Vector3 *self, void *)
{
