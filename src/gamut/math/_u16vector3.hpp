...
// generated 2022-03-12 02:08:08.738391 from codegen/math/templates/_vector.hpp

#ifndef GAMUT_MATH_U16VECTOR3_HPP
#define GAMUT_MATH_U16VECTOR3_HPP
...
static PyObject *
U16Vector3Array__getitem__(U16Vector3Array *self, Py_ssize_t index)
{
...
static PyType_Slot U16Vector3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)U16Vector3Array__getitem__},
...
static PyObject *
create_U16Vector3(uint16_t *value)
{
...
static PyObject *
create_U16Vector3Array(size_t length, uint16_t *value)
{
...
static uint16_t *
get_U16Vector3_value_ptr(PyObject *self)
{
...
static uint16_t *
get_U16Vector3Array_value_ptr(PyObject *self)
{
...
static size_t
get_U16Vector3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_U16Vector3Array_type())
    {
        PyErr_Format(
