...
// generated 2022-03-16 02:18:47.211465 from codegen/math/templates/_matrix.hpp
...
FMatrix4x2_get_row(FMatrix4x2 *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!result){ return 0; }
    result->glm = new FVector4Glm(glm::row(*self->glm, index));
    return result;
}
...
static PyObject *
FMatrix4x2Array__getitem__(FMatrix4x2Array *self, Py_ssize_t index)
{
...
static PyType_Slot FMatrix4x2Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)FMatrix4x2Array__getitem__},
