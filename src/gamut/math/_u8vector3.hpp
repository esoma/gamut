...
// generated 2022-03-12 15:44:01.730641 from codegen/math/templates/_vector.hpp

#ifndef GAMUT_MATH_U8VECTOR3_HPP
#define GAMUT_MATH_U8VECTOR3_HPP
...
static PyObject *
U8Vector3Array__getitem__(U8Vector3Array *self, Py_ssize_t index)
{
...
static PyType_Slot U8Vector3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)U8Vector3Array__getitem__},
...
static PyObject *
create_U8Vector3(uint8_t *value)
{
...
static PyObject *
create_U8Vector3Array(size_t length, uint8_t *value)
{
...
static uint8_t *
get_U8Vector3_value_ptr(PyObject *self)
{
...
static uint8_t *
get_U8Vector3Array_value_ptr(PyObject *self)
{
...
static size_t
get_U8Vector3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_U8Vector3Array_type())
    {
        PyErr_Format(
