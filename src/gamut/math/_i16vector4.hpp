// generated 2022-03-07 23:13:00.214095 from codegen/math/templates/_vector.hpp
...
static PyObject *
I16Vector4__add__(I16Vector4 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((I16Vector4 *)other)->glm);
    }
...
static PyObject *
I16Vector4__sub__(I16Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    I16Vector4Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
I16Vector4__mul__(I16Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    I16Vector4Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    I16Vector4__truediv__(I16Vector4 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        I16Vector4Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((I16Vector4 *)other)->glm)[0] == 0 ||

                        (*((I16Vector4 *)other)->glm)[1] == 0 ||

                        (*((I16Vector4 *)other)->glm)[2] == 0 ||

                        (*((I16Vector4 *)other)->glm)[3] == 0
...
I16Vector4_getbufferproc(I16Vector4 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "I16Vector4 is not read only");
        view->obj = 0;
        return -1;
    }
