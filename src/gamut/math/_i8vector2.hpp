// generated 2022-03-07 23:13:00.196094 from codegen/math/templates/_vector.hpp
...
static PyObject *
I8Vector2__add__(I8Vector2 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((I8Vector2 *)other)->glm);
    }
...
static PyObject *
I8Vector2__sub__(I8Vector2 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    I8Vector2Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
I8Vector2__mul__(I8Vector2 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    I8Vector2Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    I8Vector2__truediv__(I8Vector2 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        I8Vector2Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((I8Vector2 *)other)->glm)[0] == 0 ||

                        (*((I8Vector2 *)other)->glm)[1] == 0
...
I8Vector2_getbufferproc(I8Vector2 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "I8Vector2 is not read only");
        view->obj = 0;
        return -1;
    }
