...
static PyObject *
FVector4x3__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    if (kwds && PyDict_Size(kwds) != 0)
    {
        PyErr_SetString(
            PyExc_TypeError,
            "FVector4x3 does accept any keyword arguments"
        );
        return 0;
    }
    ...
    switch (PyTuple_GET_SIZE(args))
    {
        ...
        default:
        {
            PyErr_Format(
                PyExc_TypeError,
                "invalid number of arguments supplied to FVector4x3, expected "
                "0, 1, 4 or 12 (got %zd)",
                arg_count
            );
            return 0;
    ...
    FVector4x3 *self = (FVector4x3*)cls->tp_alloc(cls, 0);
    if (!self)
    {
        delete glm;
        return 0;
...
static void
FVector4x3__dealloc__(FVector4x3 *self)
{
    if (self->weakreflist)
    {
...
static Py_hash_t
FVector4x3__hash__(FVector4x3 *self)
{
    Py_ssize_t len = 12;
...
static PyObject *
FVector4x3__repr__(FVector4x3 *self)
{
    PyObject *result = 0;
...
static Py_ssize_t
FVector4x3__len__(FVector4x3 *self)
{
    return 4;
}
...
static PyObject *
FVector4x3__getitem__(FVector4x3 *self, Py_ssize_t index)
{
    if (index < 0 || index > 3)
    {
...
static PyType_Slot FVector4x3_PyType_Slots [] = {
    ...
    {Py_tp_hash, (void*)FVector4x3__hash__},
    ...
    /*
        ...
        {Py_nb_true_divide, (void*)FVector4x3__truediv__},


        {Py_nb_negative, (void*)FVector4x3__neg__},

    {Py_nb_absolute, (void*)FVector4x3__abs__},
    {Py_nb_bool, (void*)FVector4x3__bool__},
    {Py_bf_getbuffer, (void*)FVector4x3_getbufferproc},
    {Py_tp_getset, (void*)FVector4x3_PyGetSetDef},
    {Py_tp_getattro, (void*)FVector4x3__getattr__},
    {Py_tp_members, (void*)FVector4x3_PyMemberDef},
    {Py_tp_methods, (void*)FVector4x3_PyMethodDef},
    */
    {0, 0},
};


static PyType_Spec FVector4x3_PyTypeSpec = {
    "gamut.math.FVector4x3",
    sizeof(FVector4x3),
    0,
    Py_TPFLAGS_DEFAULT,
    FVector4x3_PyType_Slots
};


static PyTypeObject *
define_FVector4x3_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &FVector4x3_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    ...
    if (PyModule_AddObject(module, "FVector4x3", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
