// generated 2022-03-07 23:13:00.218594 from codegen/math/templates/_vector.hpp
...
static PyObject *
U64Vector4__add__(U64Vector4 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((U64Vector4 *)other)->glm);
    }
...
static PyObject *
U64Vector4__sub__(U64Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U64Vector4Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
U64Vector4__mul__(U64Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U64Vector4Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    U64Vector4__truediv__(U64Vector4 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        U64Vector4Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((U64Vector4 *)other)->glm)[0] == 0 ||

                        (*((U64Vector4 *)other)->glm)[1] == 0 ||

                        (*((U64Vector4 *)other)->glm)[2] == 0 ||

                        (*((U64Vector4 *)other)->glm)[3] == 0
...
U64Vector4_getbufferproc(U64Vector4 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "U64Vector4 is not read only");
        view->obj = 0;
        return -1;
    }
