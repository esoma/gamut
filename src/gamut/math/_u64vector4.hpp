...
// generated 2022-03-12 02:08:08.752392 from codegen/math/templates/_vector.hpp
...
static PyObject *
U64Vector4Array__getitem__(U64Vector4Array *self, Py_ssize_t index)
{
...
static PyType_Slot U64Vector4Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)U64Vector4Array__getitem__},
...
static PyObject *
create_U64Vector4(uint64_t *value)
{
...
static PyObject *
create_U64Vector4Array(size_t length, uint64_t *value)
{
...
static uint64_t *
get_U64Vector4_value_ptr(PyObject *self)
{
...
static uint64_t *
get_U64Vector4Array_value_ptr(PyObject *self)
{
...
static size_t
get_U64Vector4Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_U64Vector4Array_type())
    {
        PyErr_Format(
