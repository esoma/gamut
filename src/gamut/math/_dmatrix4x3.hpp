...
// generated 2022-03-14 18:08:34.808035 from codegen/math/templates/_matrix.hpp
...
DMatrix4x3_get_row(DMatrix4x3 *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!result){ return 0; }
    result->glm = new DVector4Glm(glm::row(*self->glm, index));
    return result;
}
...
static PyObject *
DMatrix4x3Array__getitem__(DMatrix4x3Array *self, Py_ssize_t index)
{
...
static PyType_Slot DMatrix4x3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)DMatrix4x3Array__getitem__},
