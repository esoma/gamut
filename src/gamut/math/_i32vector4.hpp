// generated 2022-03-07 23:13:00.215094 from codegen/math/templates/_vector.hpp
...
static PyObject *
I32Vector4__add__(I32Vector4 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((I32Vector4 *)other)->glm);
    }
...
static PyObject *
I32Vector4__sub__(I32Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    I32Vector4Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
I32Vector4__mul__(I32Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    I32Vector4Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    I32Vector4__truediv__(I32Vector4 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        I32Vector4Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((I32Vector4 *)other)->glm)[0] == 0 ||

                        (*((I32Vector4 *)other)->glm)[1] == 0 ||

                        (*((I32Vector4 *)other)->glm)[2] == 0 ||

                        (*((I32Vector4 *)other)->glm)[3] == 0
...
I32Vector4_getbufferproc(I32Vector4 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "I32Vector4 is not read only");
        view->obj = 0;
        return -1;
    }
...
static PyObject *
I32Vector4_get_limits(I32Vector4 *self, void *)
{
