...
// generated 2022-03-12 02:08:08.748893 from codegen/math/templates/_vector.hpp
...
static PyObject *
I32Vector4Array__getitem__(I32Vector4Array *self, Py_ssize_t index)
{
...
static PyType_Slot I32Vector4Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)I32Vector4Array__getitem__},
...
static PyObject *
create_I32Vector4(int32_t *value)
{
...
static PyObject *
create_I32Vector4Array(size_t length, int32_t *value)
{
...
static int32_t *
get_I32Vector4_value_ptr(PyObject *self)
{
...
static int32_t *
get_I32Vector4Array_value_ptr(PyObject *self)
{
...
static size_t
get_I32Vector4Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_I32Vector4Array_type())
    {
        PyErr_Format(
