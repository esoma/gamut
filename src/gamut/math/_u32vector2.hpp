// generated 2022-03-07 23:13:00.199594 from codegen/math/templates/_vector.hpp
...
static PyObject *
U32Vector2__add__(U32Vector2 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((U32Vector2 *)other)->glm);
    }
...
static PyObject *
U32Vector2__sub__(U32Vector2 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U32Vector2Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
U32Vector2__mul__(U32Vector2 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U32Vector2Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    U32Vector2__truediv__(U32Vector2 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        U32Vector2Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((U32Vector2 *)other)->glm)[0] == 0 ||

                        (*((U32Vector2 *)other)->glm)[1] == 0
...
U32Vector2_getbufferproc(U32Vector2 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "U32Vector2 is not read only");
        view->obj = 0;
        return -1;
    }
