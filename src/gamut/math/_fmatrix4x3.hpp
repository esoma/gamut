...
// generated 2022-03-12 02:08:08.798391 from codegen/math/templates/_matrix.hpp
...
static PyObject *
FMatrix4x3Array__getitem__(FMatrix4x3Array *self, Py_ssize_t index)
{
...
static PyType_Slot FMatrix4x3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)FMatrix4x3Array__getitem__},
...
static PyObject *
create_FMatrix4x3Array(size_t length, float *value)
{
...
static float *
get_FMatrix4x3_value_ptr(PyObject *self)
{
...
static float *
get_FMatrix4x3Array_value_ptr(PyObject *self)
{
...
static size_t
get_FMatrix4x3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_FMatrix4x3Array_type())
    {
        PyErr_Format(
