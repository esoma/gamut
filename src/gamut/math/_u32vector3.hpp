...
// generated 2022-03-12 02:15:24.960287 from codegen/math/templates/_vector.hpp
...
static PyObject *
U32Vector3Array__getitem__(U32Vector3Array *self, Py_ssize_t index)
{
...
static PyType_Slot U32Vector3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)U32Vector3Array__getitem__},
...
static PyObject *
create_U32Vector3(uint32_t *value)
{
...
static PyObject *
create_U32Vector3Array(size_t length, uint32_t *value)
{
...
static uint32_t *
get_U32Vector3_value_ptr(PyObject *self)
{
...
static uint32_t *
get_U32Vector3Array_value_ptr(PyObject *self)
{
...
static size_t
get_U32Vector3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_U32Vector3Array_type())
    {
        PyErr_Format(
