...
// generated 2022-03-13 19:38:42.272273 from codegen/math/templates/_matrix.hpp
...
DMatrix2x4_get_row(DMatrix2x4 *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!result){ return 0; }
    result->glm = new DVector2Glm(glm::row(*self->glm, index));
    return result;
}
...
static PyObject *
DMatrix2x4Array__getitem__(DMatrix2x4Array *self, Py_ssize_t index)
{
...
static PyType_Slot DMatrix2x4Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)DMatrix2x4Array__getitem__},
