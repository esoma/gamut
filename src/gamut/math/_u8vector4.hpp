// generated 2022-03-07 23:13:00.213595 from codegen/math/templates/_vector.hpp
...
static PyObject *
U8Vector4__add__(U8Vector4 *self, PyObject *other)
{
    ...
    {
        vector = (*self->glm) + (*((U8Vector4 *)other)->glm);
    }
...
static PyObject *
U8Vector4__sub__(U8Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U8Vector4Glm vector;
    if (Py_TYPE(other) != cls)
...
static PyObject *
U8Vector4__mul__(U8Vector4 *self, PyObject *other)
{
    auto cls = Py_TYPE(self);
    U8Vector4Glm vector;
    if (Py_TYPE(other) != cls)
    ...
    static PyObject *
    U8Vector4__truediv__(U8Vector4 *self, PyObject *other)
    {
        auto cls = Py_TYPE(self);
        U8Vector4Glm vector;
        if (Py_TYPE(other) != cls)
        ...
        else
        {
                ...
                if (
                        ...
                        (*((U8Vector4 *)other)->glm)[0] == 0 ||

                        (*((U8Vector4 *)other)->glm)[1] == 0 ||

                        (*((U8Vector4 *)other)->glm)[2] == 0 ||

                        (*((U8Vector4 *)other)->glm)[3] == 0
...
U8Vector4_getbufferproc(U8Vector4 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "U8Vector4 is not read only");
        view->obj = 0;
        return -1;
    }
