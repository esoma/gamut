...
// generated 2022-03-09 14:35:33.687730 from codegen/math/templates/_matrix.hpp

#ifndef GAMUT_MATH_FVECTOR3X4_HPP
#define GAMUT_MATH_FVECTOR3X4_HPP
...
static PyObject *
FVector3x4__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    if (kwds && PyDict_Size(kwds) != 0)
    {
        PyErr_SetString(
            PyExc_TypeError,
            "FVector3x4 does accept any keyword arguments"
        );
        return 0;
    }
    ...
    switch (PyTuple_GET_SIZE(args))
    {
        ...
        default:
        {
            PyErr_Format(
                PyExc_TypeError,
                "invalid number of arguments supplied to FVector3x4, expected "
                "0, 1, 3 or 12 (got %zd)",
                arg_count
            );
            return 0;
    ...
    FVector3x4 *self = (FVector3x4*)cls->tp_alloc(cls, 0);
    if (!self)
    {
        delete glm;
        return 0;
...
static void
FVector3x4__dealloc__(FVector3x4 *self)
{
    if (self->weakreflist)
    {
...
static Py_hash_t
FVector3x4__hash__(FVector3x4 *self)
{
    Py_ssize_t len = 12;
...
static PyObject *
FVector3x4__repr__(FVector3x4 *self)
{
    PyObject *result = 0;
...
static Py_ssize_t
FVector3x4__len__(FVector3x4 *self)
{
    return 3;
}
...
static PyObject *
FVector3x4__getitem__(FVector3x4 *self, Py_ssize_t index)
{
    if (index < 0 || index > 2)
    {
...
static PyObject *
FVector3x4__richcmp__(FVector3x4 *self, FVector3x4 *other, int op)
{
...
static PyObject *
FVector3x4__add__(PyObject *left, PyObject *right)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto cls = module_state->FVector3x4_PyTypeObject;

    FVector3x4Glm matrix;
    if (Py_TYPE(left) == Py_TYPE(right))
    {
        matrix = (*((FVector3x4 *)left)->glm) + (*((FVector3x4 *)right)->glm);
    }
    else
    {
        if (Py_TYPE(left) == cls)
        {
            ...
            matrix = (*((FVector3x4 *)left)->glm) + c_right;
        }
        else
        {
            auto c_left = pyobject_to_c_float(left);
            if (PyErr_Occurred()){ Py_RETURN_NOTIMPLEMENTED; }
            matrix = (*((FVector3x4 *)right)->glm) + c_left;
        }
    }

    FVector3x4 *result = (FVector3x4 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = new FVector3x4Glm(matrix);
...
static PyObject *
FVector3x4__sub__(PyObject *left, PyObject *right)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto cls = module_state->FVector3x4_PyTypeObject;
...
static PyObject *
FVector3x4__mul__(PyObject *left, PyObject *right)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto cls = module_state->FVector3x4_PyTypeObject;
...

        {
            ...
            if (Py_TYPE(right) == right_cls)
            {
                ...
                result->glm = new FMatrix2x3Glm(
                    (*((FVector3x4 *)left)->glm) * (*((FMatrix2x3 *)right)->glm)
                );
                return (PyObject *)result;
            }
        }
...

        {
            ...
            if (Py_TYPE(right) == right_cls)
            {
                ...
                result->glm = new FMatrix3x3Glm(
                    (*((FVector3x4 *)left)->glm) * (*((FMatrix3x3 *)right)->glm)
                );
                return (PyObject *)result;
            }
        }
...

        {
            ...
            if (Py_TYPE(right) == right_cls)
            {
                ...
                result->glm = new FMatrix4x3Glm(
                    (*((FVector3x4 *)left)->glm) * (*((FMatrix4x3 *)right)->glm)
                );
                return (PyObject *)result;
            }
        }
...
static PyType_Slot FVector3x4_PyType_Slots [] = {
    {Py_tp_new, (void*)FVector3x4__new__},
    {Py_tp_dealloc, (void*)FVector3x4__dealloc__},
    {Py_tp_hash, (void*)FVector3x4__hash__},
    {Py_tp_repr, (void*)FVector3x4__repr__},
    {Py_sq_length, (void*)FVector3x4__len__},
    {Py_sq_item, (void*)FVector3x4__getitem__},
    {Py_tp_richcompare, (void*)FVector3x4__richcmp__},
    {Py_nb_add, (void*)FVector3x4__add__},
    {Py_nb_subtract, (void*)FVector3x4__sub__},
    {Py_nb_multiply, (void*)FVector3x4__mul__},
    /*
        {Py_nb_matrix_multiply, (void*)FVector3x4__matmul__},
        {Py_nb_remainder, (void*)FVector3x4__mod__},
        {Py_nb_power, (void*)FVector3x4__pow__},


        {Py_nb_true_divide, (void*)FVector3x4__truediv__},


        {Py_nb_negative, (void*)FVector3x4__neg__},

    {Py_nb_absolute, (void*)FVector3x4__abs__},
    {Py_nb_bool, (void*)FVector3x4__bool__},
    {Py_bf_getbuffer, (void*)FVector3x4_getbufferproc},
    {Py_tp_getset, (void*)FVector3x4_PyGetSetDef},
    {Py_tp_getattro, (void*)FVector3x4__getattr__},
    {Py_tp_members, (void*)FVector3x4_PyMemberDef},
    {Py_tp_methods, (void*)FVector3x4_PyMethodDef},
    */
    {0, 0},
};


static PyType_Spec FVector3x4_PyTypeSpec = {
    "gamut.math.FVector3x4",
    sizeof(FVector3x4),
    0,
    Py_TPFLAGS_DEFAULT,
    FVector3x4_PyType_Slots
};


static PyTypeObject *
define_FVector3x4_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &FVector3x4_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    ...
    if (PyModule_AddObject(module, "FVector3x4", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
