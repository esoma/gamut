...
// generated 2022-03-12 02:08:08.735394 from codegen/math/templates/_vector.hpp
...
static PyObject *
FVector3Array__getitem__(FVector3Array *self, Py_ssize_t index)
{
...
static PyType_Slot FVector3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)FVector3Array__getitem__},
...
static PyObject *
create_FVector3Array(size_t length, float *value)
{
...
static float *
get_FVector3_value_ptr(PyObject *self)
{
...
static float *
get_FVector3Array_value_ptr(PyObject *self)
{
...
static size_t
get_FVector3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_FVector3Array_type())
    {
        PyErr_Format(
