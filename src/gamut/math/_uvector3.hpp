...
// generated 2022-03-12 02:15:24.961787 from codegen/math/templates/_vector.hpp
...
static PyObject *
UVector3Array__getitem__(UVector3Array *self, Py_ssize_t index)
{
...
static PyType_Slot UVector3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)UVector3Array__getitem__},
...
static PyObject *
create_UVector3(unsigned int *value)
{
...
static PyObject *
create_UVector3Array(size_t length, unsigned int *value)
{
...
static unsigned int *
get_UVector3_value_ptr(PyObject *self)
{
...
static unsigned int *
get_UVector3Array_value_ptr(PyObject *self)
{
...
static size_t
get_UVector3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_UVector3Array_type())
    {
        PyErr_Format(
