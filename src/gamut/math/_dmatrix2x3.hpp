...
// generated 2022-03-12 02:15:25.007786 from codegen/math/templates/_matrix.hpp
...
static PyObject *
DMatrix2x3Array__getitem__(DMatrix2x3Array *self, Py_ssize_t index)
{
...
static PyType_Slot DMatrix2x3Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)DMatrix2x3Array__getitem__},
...
static PyObject *
create_DMatrix2x3(double *value)
{
...
static PyObject *
create_DMatrix2x3Array(size_t length, double *value)
{
...
static double *
get_DMatrix2x3_value_ptr(PyObject *self)
{
...
static double *
get_DMatrix2x3Array_value_ptr(PyObject *self)
{
...
static size_t
get_DMatrix2x3Array_length(PyObject *self)
{
    if (Py_TYPE(self) != get_DMatrix2x3Array_type())
    {
        PyErr_Format(
