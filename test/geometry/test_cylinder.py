...
def test_hash() -> None:
    c1 = Cylinder(Vector3(1, 2, 3), 4, 5, rotation=Quaternion(6, 7, 8, 9))
    c2 = Cylinder(Vector3(1, 2, 3), 4, 5, rotation=Quaternion(6, 7, 8, 9))
...
def test_invalid_rotation(rotation: Any) -> None:
    with pytest.raises(TypeError) as excinfo:
        Cylinder(Vector3(0), 0, 0, rotation=rotation)
...
def test_equal() -> None:
    assert Cylinder(Vector3(0), 0, 0) == Cylinder(Vector3(0), 0, 0)
    assert Cylinder(Vector3(0), 0, 0) != Cylinder(Vector3(1, 0, 0), 0, 0)
    assert Cylinder(Vector3(0), 0, 0) != Cylinder(Vector3(0, 1, 0), 0, 0)
    assert Cylinder(Vector3(0), 0, 0) != Cylinder(Vector3(0, 0, 1), 0, 0)
    assert Cylinder(Vector3(0), 0, 0) != Cylinder(Vector3(0), 1, 0)
    assert Cylinder(Vector3(0), 0, 0) != Cylinder(Vector3(0), 0, 1)
    assert Cylinder(Vector3(0), 0, 0) != object()
